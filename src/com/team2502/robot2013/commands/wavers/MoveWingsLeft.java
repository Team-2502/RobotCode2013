 ...
 * @author josh
 */
public class MoveWingsLeft extends CommandBase {
	
	public MoveWingsLeft() {
		requires(wavers);
	}

	// Called just before this Command runs the first time
	protected void initialize() {
		wavers.setLeftToucher(Wavers.ServoPosition.LEFT_OUT);
		wavers.setRightToucher(Wavers.ServoPosition.RIGHT_IN);
	}
